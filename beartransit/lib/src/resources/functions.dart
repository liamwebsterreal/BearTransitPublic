...
busLine returnCLine(){
  return busLine('C-Line', 'Weekdays 6:45 a.m. to 11:15 a.m. 4:15 p.m. to 7:15 p.m.', 'Every 20 minutes.', AssetImage('lib/src/resources/assets/c_line.png'), 'Uphill via Hearst|Downhill via Memorial Glade/University Dr');
}
busLine returnHLine() {
  return busLine('H-Line', 'Weekdays 7:35 a.m. to 7:25 p.m.', 'Every 30 minutes.', AssetImage('lib/src/resources/assets/h_line.png'), 'Uphill to Lawrence Hall & Space Science Lab|Downhill to Mining Circle');
}
busLine returnPLine() {
  return busLine('P-Line', 'Weekdays 7:00 a.m. to 7:30 p.m.', 'Every 30 minutes.', AssetImage('lib/src/resources/assets/p_line.png'), 'Uphill via Hearst|Downhill via Bancroft');
}
busLine returnRLine() {
  return busLine('R-Line', 'Weekdays 7:15 am to 6:45pm', 'Every 30 minutes.', AssetImage('lib/src/resources/assets/r_line.png'), 'Uphill via Channing & Piedmont|Downhill via Hearst');
}
